            ...
            <div className="card p-6">
                <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-slate-500 dark:text-slate-400">Customize how TaskFlow looks</p>
                    </div>
                </div>
            ...
            <div className="card p-6">
                <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-slate-500 dark:text-slate-400">Configure your reminder preferences</p>
                    </div>
                </div>
                <div className="space-y-4">
                    <div className="flex items-center justify-between">
